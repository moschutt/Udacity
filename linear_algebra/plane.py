    ...
    def __eq__(self, p):
        ...
        if self.normal_vector.is_zero():
            ...
            if not p.normal_vector.is_zero():
                ...
                d = self.constant_term - p.constant_term
